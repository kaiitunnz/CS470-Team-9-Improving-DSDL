...
# For automatically saving checkpoints to Google Drive when running on Google Colab,
parser.add_argument('--drive', default=None, type=str, metavar='CHKPNT', 
                    help='the path to a folder on Google Drive for storing checkpoints')
